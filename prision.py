...
class Prision:
    ...
    def entry():
        print("Tonight, {PrisionName} welcomes a new inmate.".format(PrisionName=Guantanamo.name))

        name = str(input("Please enter your name:..."))
        print("{name} has been registered. Please proceed to the holding cells.".format(name=name))
...
Guantanamo = Prision("Guantanamo Bay")
Prision.entry()
